...
function getStrength(pw: string) {
  ...
  const bgs    = ["", "#FEF2F2", "#FFFBEB", "#EFF6FF", "#F0FDF4"];
...
function Logo() {
  return (
    <Box sx={{ display: "flex", alignItems: "center", gap: 1.5, cursor: "pointer", flexShrink: 0,
      transition: "transform 0.2s ease", "&:hover": { transform: "scale(1.02)" } }}>
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        @keyframes rpBarGrow { from{width:0} to{} }
        ...
        <div className="rp-card" style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: 22, fontWeight: 800, color: "#fff", letterSpacing: "-0.3px", marginBottom: 6 }}>
              {step === 1 ? "Create new password 🔑" : "Password reset! 🎉"}
            </div>
            ...
            {step === 1 && (
              <div className="rp-step">
                <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      <input
                        ...
                        value={password}
                        onChange={e => { setPassword(e.target.value); setErrors(er => ({ ...er, pw: "" })); }}
                  ...
                  <div style={{
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 7 }}>
                      {RULES.map((rule, i) => {
                        ...
                        return (
                          <div key={rule.id} className="rp-rule"
                            style={{ animationDelay: `${i * 0.05}s`, display: "flex", alignItems: "center", gap: 8 }}>
                            <div style={{
                              width: 18, height: 18, borderRadius: "50%", flexShrink: 0,
                              background: passed ? "#ECFDF5" : "#F3F4F6",
                              border: `1.5px solid ${passed ? "#10B981" : "#E5E7EB"}`,
                              display: "flex", alignItems: "center", justifyContent: "center",
                            ...
                            <span style={{ fontSize: 12.5, color: passed ? "#374151" : "#9CA3AF", fontWeight: passed ? 600 : 400, transition: "all 0.2s" }}>
                              {rule.label}
                            </span>
                          </div>
                        );
                  ...
                  {/* Submit */}
                  <button type="submit" className="rp-submit" disabled={loading} style={{ marginTop: 2 }}>
                    {loading
            ...
            {step === 2 && (
              <div className="rp-step" style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
                ...
                <div className="rp-success-icon" style={{ marginBottom: 22, position: "relative" }}>
                  <div className="rp-success-pulse" style={{
                    ...
                    <svg width="42" height="42" viewBox="0 0 42 42" fill="none">
                      <path d="M21 3L6 9v9c0 9.94 6.44 19.26 15 21.62C29.56 37.26 36 27.94 36 18V9L21 3z"
                        fill={`${BRAND}18`} stroke={BRAND} strokeWidth="1.8" strokeLinejoin="round"/>
                  ...
                  {[
                    ...
                    <div key={i} style={{
                      ...
                      top: (d as any).top, right: (d as any).right,
                      bottom: (d as any).bottom, left: (d as any).left,
                      animation: `rpPop 0.5s ${0.1 + i * 0.07}s cubic-bezier(0.34,1.56,0.64,1) both`,
                    }} />
                  ))}
                </div>

                <h2 style={{ margin: "0 0 8px", fontSize: 22, fontWeight: 800, color: "#0F172A", letterSpacing: "-0.3px" }}>
                  Password Updated!
                </h2>
